...
const texts = {
  home: { en: 'Home', am: 'መነሻ' },
  menu: { en: 'Menu', am: 'ሜኑ' },
  order: { en: 'Cart', am: 'ካርት' },
  orders: { en: 'Orders', am: 'ኦርደሮች' },
  track: { en: 'Track', am: 'ትራክ' },
  viewMenu: { en: 'View Menu', am: 'ሜኑ ክፈት' },
  ...
  all: { en: 'All', am: 'ሁሉም' },
  search: { en: 'Search dishes, drinks, or ingredients...', am: 'ምግብ ወይም መጠጥ ፈልግ...' },
  subtotal: { en: 'Subtotal', am: 'ንዑስ ድምር' },
  total: { en: 'Total', am: 'ጠቅላላ' },
  paymentMethod: { en: 'Payment Method', am: 'ክፍያ መንገድ' },
  placeOrderPay: { en: 'Place Order', am: 'ኦርደር ላክ' },
  processingPayment: { en: 'Processing order...', am: 'ኦርደር እየተላከ ነው...' },
  yourOrder: { en: 'Your Cart', am: 'የእርስዎ ካርት' },
  orderEmpty: { en: 'Your cart is empty.', am: 'ካርትዎ ባዶ ነው።' },
  items: { en: 'items', am: 'እቃ' },
  estimatedTime: { en: 'Estimated Time', am: 'የተገመተ ጊዜ' },
  mins: { en: 'mins', am: 'ደቂቃ' },
  orderDetails: { en: 'Order Details', am: 'የኦርደር ዝርዝር' },
  ...
  backToMenu: { en: 'Back to menu', am: 'ወደ ሜኑ ተመለስ' },
  backToRestaurant: { en: 'Back to home', am: 'ወደ መነሻ ተመለስ' },
  back: { en: 'Back', am: 'ተመለስ' },
  trackOrder: { en: 'Track Order', am: 'ኦርደር ተከታተል' },
  trackYourOrder: { en: 'Track your live order', am: 'ኦርደርዎን ተከታተል' },
  pasteOrderId: { en: 'Enter an order ID', am: 'Order ID አስገባ' },
  fetchOrderStatus: { en: 'Fetching order status...', am: 'የኦርደር ሁኔታ በመጫን ላይ...' },
  ...
  completePayment: { en: 'Complete Payment', am: 'ክፍያ ጨርስ' },
  markFailed: { en: 'Mark as Failed', am: 'እንዳልተሳካ አሳይ' },
  trackMyOrder: { en: 'Track My Order', am: 'ኦርደሬን ተከታተል' },
  returnToOrder: { en: 'Return to cart', am: 'ወደ ካርት ተመለስ' },
  enterOrderIdHelp: { en: 'Use your order ID to reopen live tracking at any time.', am: 'ማንኛውም ጊዜ Order ID በመጠቀም ትራክ ክፈት።' },
  failedFetchOrder: { en: 'Failed to fetch order.', am: 'ኦርደር ማምጣት አልተቻለም።' },
  add: { en: 'Add', am: 'ጨምር' },
  ...
  openOrders: { en: 'Open orders', am: 'ኦርደሮች ክፈት' },
  recentOrdersEmpty: { en: 'Your recent orders will show up here after checkout.', am: 'ከመክፈያ በኋላ የቅርብ ትዕዛዞችዎ እዚህ ይታያሉ።' },
  browseDishes: { en: 'Browse dishes', am: 'ሜኑ ተመልከት' },
  goToCart: { en: 'Go to cart', am: 'ወደ ካርት ሂድ' },
  trackOrders: { en: 'Track orders', am: 'ኦርደሮችን ተከታተል' },
  ...
  orderPlacedSuccess: { en: 'Order sent to the kitchen.', am: 'ኦርደር ወደ ኩሽና ተልኳል።' },
  ...
  openTracking: { en: 'Open tracking', am: 'ትራክ ክፈት' },
